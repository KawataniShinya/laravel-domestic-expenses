...
class PaymentRepositoryImpl implements PaymentRepository
{
    ...
    public function insertPayment(int $summary_ym, int $group_id, int $member_id, int $category_id, int|null $categorizedPaymentId, string|null $payment_date, int $amount, string|null $payment_label): \App\Http\Services\DTO\Common\Payment
    {
        $payment = Payment::create([
            ...
            'categorized_payment_id' => $categorizedPaymentId,
